...
interface StakingRewardsV2Interface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsV2 extends BaseContract {
  ...
  interface: StakingRewardsV2Interface;
